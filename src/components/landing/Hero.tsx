      ...
      <div className="max-w-2xl">
        ...
        <div className="space-y-4 mb-12">
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
            Because I'm tired of apps that track us, platforms that own our data, and a web that treats us as products.
          </p>
          <p className="text-lg md:text-xl text-foreground/80 leading-relaxed">
            This is my corner of the internet where I ship tools that put us back in control.
          </p>
        </div>

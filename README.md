# neo21.dev — Tools for Sovereign Individuals

Apps that don't track you. Platforms that don't own you.  
...
**[neo21.dev](https://neo21.dev)**

## NIP-05 Verification

This site serves a `/.well-known/nostr.json` for Nostr NIP-05 identity verification at the `neo21.dev` domain.

## License

Open source. Built for the open internet.
